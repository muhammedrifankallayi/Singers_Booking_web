            ...
            <div className='main_artist_view_pagess bg-gray-200 p-3'>
                <div class="searchFilter ">
                    <form class="md:flex ">
                        <div class="dropdown">
                            ...
                            <button class="dropbtns">{selectedCategory ? selectedCategory : "Category"}</button>
                            <div class="dropdown-content">
                                {selectedCategory && < a onClick={() => filter('all')}> Clear</a>}
                                {category?.map((element) => {
                                    return < a onClick={() => { return filter(element?._id), setSelectedCategory(element?.name) }} >{element?.name}</a>
                                })
                                }
                            </div>
                        </div>
                        ...
                        <div class="dropdown">
                            ...
                            >
                                <option value="Low"> price To High</option>
                                <option value="High">price To Low</option>
                            </select>
                        </div>
                    </form >
                </div >
                ...
                < div className='d-flex showArtist_div ' >
                    {
                        artistMore.filter((user) => {
                            return search && search.toLowerCase() === '' ?
                                user :
                                user.firstName.toLowerCase().includes(search.toLowerCase()) || user.lastName.toLowerCase().includes(search.toLocaleLowerCase())
                        }).sort((a, b) => {
                            if (sortingOrder === 'asc') {
                            ...
                            .map((element) => {
                                return < div class="w-full max-w-sm  border border-black rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 artist-cart-div" >
                                    <a href="#">
                                        <img class="p-8 rounded-t-lg" onClick={() => artistView(element?._id)} src={element?.image} alt=" product image" />
                                    </a>
                                    <div class="px-5 pb-5">
                                        <a href="#">
                                            <h5 class="text-xl font-semibold tracking-tight text-white dark:text-white">{element.firstName + ' ' + element.lastName}</h5>
                                        </a>
                                        <p class="text-white dark:text-gray-400">{truncate(element?.discription, 80)}</p>
                                        ...
                                        <div class="flex element-center justify-between">
                                            <span class="text-3xl font-bold text-white dark:text-white">RS: {element?.midBudjet}</span>
                                            <Link
                ...
                <div className='pagination_div'>
                    <ReactPaginate
                        ...
                        pageLinkClassName={'flex element-center justify-center w-8 h-8 px-3 text-1xl font-bold leading-tight text-white border border-gray-300  dark:bg-gray-800 dark:border-gray-700 dark:text-white-400 pt-1 '}
